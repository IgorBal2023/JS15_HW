...
// let nameTask = `Calculate average age of users older then 17 and younger then 55`;
// startOfTask(nameTask);
...
//   ];
//  function sortUsers(arrSort) {arrSort.sort((a,b) => {
//     if (a.name < b.name)
//     {return -1;}
...
// let nameTask = `Save only unique values`;
// startOfTask(nameTask);
